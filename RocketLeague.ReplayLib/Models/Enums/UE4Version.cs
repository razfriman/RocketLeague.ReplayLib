namespace RocketLeague.ReplayLib
{
    ...
    {
        VerUe4DetermineByGame = -1,
        
        // Pre-release UE4 file versions
        VerUe4AssetRegistryTags = 112,
        VerUe4TextureDerivedData2 = 124,
        VerUe4AddCookedToTexture2D = 125,
        VerUe4RemovedStripData = 130,
        VerUe4RemoveExtraSkelmeshVertexInfluences = 134,
        VerUe4TextureSourceArtRefactor = 143,
        VerUe4AddSkelmeshMeshtoimportvertexmap = 152,
        VerUe4RemoveArchetypeIndexFromLinkerTables = 163,
        VerUe4RemoveNetIndex = 196,
        VerUe4BulkdataAtLargeOffsets = 198,
        VerUe4SummaryHasBulkdataOffset = 212,
        VerUe4StaticMeshStoreNavCollision = 216,
        VerUe4DeprecatedStaticMeshThumbnailPropertiesRemoved = 242,
        VerUe4ApexCloth = 254,
        VerUe4StaticSkeletalMeshSerializationFix = 269,
        VerUe4Support32BitStaticMeshIndices = 277,
        VerUe4ApexClothLod = 280,
        VarUe4ArrayPropertyInnerTags = 282, // note: here's a typo in UE4 code - "VAR_" instead of "VER_"
        VerUe4KeepSkelMeshIndexData = 283,
        VerUe4MoveSkeletalmeshShadowcasting = 302,
        VerUe4ReferenceSkeletonRefactor = 310,
        VerUe4FixupRootboneParent = 312,
        VerUe4FixAnimationbaseposeSerialization = 331,
        VerUe4Support8BoneInfluencesSkeletalMeshes = 332,
        VerUe4SupportGpuskinning8BoneInfluences = 334,
        VerUe4AnimSupportNonuniformScaleAnimation = 335,
        VerUe4EngineVersionObject = 336,
        VerUe4SkeletonGuidSerialization = 338,
        ...
        VerUe40 = 342,
        VerUe4MorphtargetCpuTangentzdeltaFormatchange = 348,
        VerUe41 = 352,
        VerUe42 = 363,
        VerUe4LoadForEditorGame = 365,
        VerUe4FtextHistory = 368, // used for UStaticMesh versioning
        VerUe4StoreBoneExportNames = 370,
        VerUe43 = 382,
        VerUe4AddStringAssetReferencesMap = 384,
        VerUe44 = 385,
        VerUe4SkeletonAddSmartnames = 388,
        VerUe4AddedCurrencyCodeToFtext = 389,
        VerUe4EnumClassSupport = 390,
        VerUe4FixupWidgetAnimationClass = 391,
        VerUe4SoundCompressionTypeAdded = 392,
        VerUe4AutoWelding = 393,
        VerUe4RenameCrouchmovescharacterdown = 394, // used for UStaticMesh versioning
        VerUe4LightmapMeshBuildSettings = 395,
        VerUe4RenameSm3ToEs31 = 396,
        VerUe4DeprecateUmgStyleAssets = 397, // used for UStaticMesh versioning
        VerUe4PostDuplicateNodeGuid = 398,
        VerUe4RenameCameraComponentViewRotation = 399,
        VerUe4CasePreservingFname = 400,
        VerUe45 = 401, // VER_UE4_RENAME_CAMERA_COMPONENT_CONTROL_ROTATION
        VerUe4FixRefractionInputMasking = 402,
        VerUe4GlobalEmitterSpawnRateScale = 403,
        VerUe4CleanDestructibleSettings = 404,
        VerUe4CharacterMovementUpperImpactBehavior = 405,
        VerUe4BpMathVectorEqualityUsesEpsilon = 406,
        VerUe4FoliageStaticLightingSupport = 407,
        VerUe4SlateCompositeFonts = 408,
        VerUe4RemoveSavegamesummary = 409,
        VerUe4RemoveSkeletalmeshComponentBodysetupSerialization = 410,
        VerUe4SlateBulkFontData = 411,
        VerUe4AddProjectileFrictionBehavior = 412,
        VerUe46 = 413, // VER_UE4_MOVEMENTCOMPONENT_AXIS_SETTINGS
        VerUe4GraphInteractiveCommentbubbles = 414,
        VerUe4LandscapeSerializePhysicsMaterials = 415,
        VerUe4RenameWidgetVisibility = 416, // used for UStaticMesh versioning
        VerUe4AnimationAddTrackcurves = 417,
        VerUe4MontageBranchingPointRemoval = 418,
        VerUe4BlueprintEnforceConstInFunctionOverrides = 419,
        VerUe4AddPivotToWidgetComponent = 420, // :)
        VerUe4PawnAutoPossessAi = 421,
        VerUe4FtextHistoryDateTimezone = 422,
        VerUe4SortActiveBoneIndices = 423,
        VerUe4PerframeMaterialUniformExpressions = 424,
        VerUe4MikktspaceIsDefault = 425,
        VerUe4LandscapeGrassCooking = 426,
        VerUe4FixSkelVertOrientMeshParticles = 427,
        VerUe4LandscapeStaticSectionOffset = 428,
        VerUe4AddModifiersRuntimeGeneration = 429,
        VerUe4MaterialMaskedBlendmodeTidy = 430,
        VerUe4MergedAddModifiersRuntimeGenerationTo47Deprecated = 431,
        VerUe4AfterMergedAddModifiersRuntimeGenerationTo47Deprecated = 432,
        VerUe4MergedAddModifiersRuntimeGenerationTo47 = 433,
        VerUe47 = 434, // VER_UE4_AFTER_MERGING_ADD_MODIFIERS_RUNTIME_GENERATION_TO_4_7
        VerUe4SerializeLandscapeGrassData = 435,
        VerUe4OptionallyClearGpuEmittersOnInit = 436,
        VerUe4StructGuidInPropertyTag = 441,
        VerUe4PackageSummaryHasCompatibleEngineVersion = 444,
        VerUe48 = 451,
        VerUe4SerializeTextInPackages = 459,
        VerUe49 = 482,
        VerUe410 = VerUe49, // exactly the same file version for 4.9 and 4.10
        VerUe4CookedAssetsInEditorSupport = 485,
        VerUe4SoundConcurrencyPackage = 489, // used for UStaticMesh versioning
        VerUe411 = 498,
        VerUe4InjectBlueprintStructPinConversionNodes = 499,
        VerUe4InnerArrayTagInfo = 500,
        VerUe4FixSlotNameDuplication = 501,
        VerUe4StreamableTextureAabb = 502,
        VerUe4PropertyGuidInPropertyTag = 503,
        VerUe4NameHashesSerialized = 504,
        VerUe412 = 504,
        VerUe413 = 505,
        VerUe4PreloadDependenciesInCookedExports = 507,
        VerUe4TemplateIndexInCookedExports = 508,
        VerUe414 = 508,
        VerUe4PropertyTagSetMapSupport = 509,
        VerUe4AddedSearchableNames = 510,
        VerUe415 = 510,
        VerUe464BitExportmapSerialsizes = 511,
        VerUe416 = 513,
        VerUe417 = 513,
        VerUe4AddedSoftObjectPath = 514,
        VerUe418 = 514,
        VerUe4AddedPackageSummaryLocalizationId = 516,
        VerUe419 = 516,
        VerUe420 = 516,
        VerUe421 = 517,
        VerUe422 = 517,
        VerUe423 = 517,
        VerUe4AddedPackageOwner = 518,
        VerUe424 = 518,
        VerUe425 = 518,
        VerUe4SkinweightProfileDataLayoutChanges = 519,
        VerUe4NonOuterPackageImport = 520,
        VerUe426 = 522,
        VerUe427 = 523, //?? TODO
        //Add new ones here
        VerUe4Last,
        VerUe4Latest = VerUe4Last - 1
    }
    ...
    public enum EUnrealEngineObjectLicenseeUe4Version
    {
        ...
        VerLicAutomaticVersionPlusOne,
        VerLicAutomaticVersion = VerLicAutomaticVersionPlusOne - 1
    }
