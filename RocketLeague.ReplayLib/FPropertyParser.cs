...
namespace RocketLeague.ReplayLib
{
    ...
    {
        public static FProperty DeserializePropertyContainer(BinaryReader reader) =>
            new()
            {
                Properties = DeserializeProperties(reader)
            };

        public static Dictionary<string, FProperty> DeserializeProperties(BinaryReader reader)
        {
        ...
        public static FProperty Deserialize(BinaryReader reader)
        {
            ...
            switch (type)
            {
                ...
                case "ArrayProperty":
                    ...
                    break;
                default:
                    throw new InvalidDataException($"Unknown FProperty type: {type}");
            }
